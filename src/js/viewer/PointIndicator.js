...
import { PointsNodeMaterial } from '../../../node_modules/three/examples/jsm/nodes/Nodes.js';
...
class PointIndicator extends Point {
	...
	constructor ( ctx, color ) {
		...
		const material = new PointsNodeMaterial( { size: 32, map: materials.pointerTexture, transparent : true, sizeAttenuation: false, alphaTest: 0.8, color: color } );
