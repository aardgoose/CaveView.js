import { TextureLoader, Sprite } from '../Three';
...
class PointIndicator extends Sprite {
	...
	constructor ( ctx, color ) {
		...
		const material = new SpriteNodeMaterial( { map: materials.pointerTexture, transparent : true, sizeAttenuation: false, alphaTest: 0.8, color: color } );
